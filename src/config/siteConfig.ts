...
export const siteConfig: SiteConfig = {
	title: "Goblinの小屋",
	subtitle: "一只goblin日常活动的地方",
	siteURL: "https://blingo406.github.io/", // 请替换为你的站点URL，以斜杠结尾
	...
	navbarTitle: {
		...
		icon: "assets/optimized/nav-icon.webp",
		// 网站Logo图片路径
		logo: "assets/optimized/nav-logo.webp",
	},
	...
	bilibili: {
		vmid: "493650543", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	banner: {
		...
		homeText: {
			...
			subtitle: [
				"没有什么特别的事，但只要有你在，就已经足够了。",
				"即使是现在，你依然是我的光。",
				"你啊，不知不觉就成了我每一天的一部分。",
				"和你说话的话，总觉得每天都会变得稍微开心一点。",
				"今天是平淡无奇的一天。但是，却又有那么一点点的美好。",
			],
			typewriter: {
