				...
				[
					rehypeComponents,
					{
						components: {
							...
							abstract: (x, y) => AdmonitionComponent(x, y, "abstract"),
							...
							failure: (x, y) => AdmonitionComponent(x, y, "failure"),
							danger: (x, y) => AdmonitionComponent(x, y, "danger"),
							bug: (x, y) => AdmonitionComponent(x, y, "bug"),
							example: (x, y) => AdmonitionComponent(x, y, "example"),
							quote: (x, y) => AdmonitionComponent(x, y, "quote"),
						},
					},
				],
				[
